...
// EntityMPartsEnhanceProbability is table key "m_parts_enhance_probability".
type EntityMPartsEnhanceProbability struct {
	_                 struct{} `msgpack:",array"`
	EnhancePatternId  int32
	EnhanceMain       int32 // 0 or 1 - whether main stat is enhanced
	EnhanceSubCount   int32 // 0-4 - number of sub-stats enhanced
	ProbabilityPermil int32
}
...
// Price is a decimal string in the master data (e.g. "120.00").
