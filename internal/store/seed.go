...
func SeedUserState(userId int64, userUuid string, nowMillis int64, platform model.ClientPlatform) *UserState {
	user := &UserState{
		UserId:               userId,
		Uuid:                 userUuid,
		PlayerId:             userId,
		...
		CageOrnamentAccesses:     make(map[int32]CageOrnamentAccessState),
