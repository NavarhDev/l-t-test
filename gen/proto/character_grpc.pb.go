...
const (
	CharacterService_Rebirth_FullMethodName = "/apb.api.character.CharacterService/Rebirth"
)
...
type CharacterServiceClient interface {
	Rebirth(ctx context.Context, in *RebirthRequest, opts ...grpc.CallOption) (*RebirthResponse, error)
}
...
func (c *characterServiceClient) Rebirth(ctx context.Context, in *RebirthRequest, opts ...grpc.CallOption) (*RebirthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RebirthResponse)
	err := c.cc.Invoke(ctx, CharacterService_Rebirth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CharacterServiceServer interface {
	Rebirth(context.Context, *RebirthRequest) (*RebirthResponse, error)
...
func (UnimplementedCharacterServiceServer) Rebirth(context.Context, *RebirthRequest) (*RebirthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Rebirth not implemented")
}
...
func _CharacterService_Rebirth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RebirthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CharacterServiceServer).Rebirth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CharacterService_Rebirth_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CharacterServiceServer).Rebirth(ctx, req.(*RebirthRequest))
	}
...
var CharacterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "apb.api.character.CharacterService",
	HandlerType: (*CharacterServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Rebirth",
			Handler:    _CharacterService_Rebirth_Handler,
		},
	},
